                ...
                <div className="footer-top">
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-links">
                            <li><a href="#hero">{tNav("home")}</a></li>
                            <li><a href="#servicii">{tNav("services")}</a></li>
                            <li><a href="#galerie">{tNav("gallery")}</a></li>
                            <li><a href="#contact">{tNav("contact")}</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-col">
                        <h4>{t("collections")}</h4>
                        <ul className="footer-links">
                            <li><a href="#galerie">{t("limited")}</a></li>
                            <li><a href="#galerie">{t("classic")}</a></li>
                            <li><a href="#galerie">{t("seasons")}</a></li>
                            <li><a href="#galerie">{t("noir")}</a></li>
                            <li><a href="#galerie">{t("special")}</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-col">
                        ...
                        <div className="contact-item">
                            ...
                            <span>Str. Artizanilor nr. 14<br />Bucuresti, Romania</span>
                        </div>
                        <div className="contact-item">
