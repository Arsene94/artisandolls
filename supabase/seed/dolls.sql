...
--
-- Important:
-- The app now uses main_image_path / image_paths.
-- The legacy main_image_url / image_urls columns are also populated for backward compatibility.
...
select
    ...
    collection,
    description,
    main_image as main_image_path,
    gallery_images as image_paths,
    main_image as main_image_url,
    gallery_images as image_urls,
    badge,
    availability,
    available_for_rent,
    available_for_buy,
